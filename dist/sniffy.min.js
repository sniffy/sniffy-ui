...
s.open(),s.write(r),s.close();var t=e(s.getElementById("sniffy-queries"));e(s.getElementById("sniffy-iframe-close")).on("click",function(){n(),q(!1)});var u=e("span",e(s.getElementById("sniffy-iframe-maximize"))).toggle({$:"+glyphicon-resize-full -glyphicon-resize-small"},{$:"+glyphicon-resize-small -glyphicon-resize-full"}),v=function(){q(),o(),u()};e(s.getElementById("sniffy-iframe-maximize")).on("click",v),i=function(a){window.sniffy.numberOfSqlQueries+=a,e(".sniffy-query-count").fill(window.sniffy.numberOfSqlQueries)},i(parseInt(l)),h(location.pathname,j+"request/"+c),h=function(a,b){e.request("get",b).then(function(b,c){var d=f("tr",[f("td","No queries"),f("td","")]);m.get("contentWindow").hljs.configure({useBR:!0});var g=e.parseJSON(b),h=g.executedQueries;if(t.add(f("tr",[f("th",{},a),f("th",{},g.time)])),200===c.status)if(0===h.length)t.add(d);else for(var i=function(a){return function(){var b=e(s.getElementById("show-stack-"+a)),c=e(s.getElementById("stackTrace-"+a));b.is(".show-stack")?(b.set("$","-show-stack"),b.fill("Hide stack trace"),c.show()):(b.set("$","+show-stack"),b.fill("Show stack trace"),c.hide())}},j=0;j<h.length;j++){var k,l,n=h[j],o=++window.sniffy.statementsCounter;t.add(f("tr",[f("td",[f("div",[k=f("code",{"@class":"language-sql"},n.query)])]),f("td",n.time)])),m.get("contentWindow").hljs.highlightBlock(k[0]),n.stackTrace&&0!==n.stackTrace.length||(n.stackTrace="No stack trace available"),t.add(f("tr",[f("td",{"@colspan":2},[f("div",[f("button",{"@class":"btn btn-link btn-xs show-stack","@id":"show-stack-"+o},"Show stack trace").on("click",i(o)),l=f("code",{"@class":"java",$display:"none","@id":"stackTrace-"+o},n.stackTrace)])])])),m.get("contentWindow").hljs.highlightBlock(l[0])}else t.add(d)}).error(function(a,b,c){console.log(a+" "+b+" "+c)})};for(var w=0;w<g.length;w++){var x=g[w];h(x.url,x.requestId)}}),function(a){var b=a.prototype.open,c=a.prototype.send;a.prototype.open=function(a,c,d,e,f){this._url=c,this._method=a,b.call(this,a,c,d,e,f)},a.prototype.send=function(a){function b(){if(4===f.readyState){var a=f.getResponseHeader("X-Sql-Queries");if(a&&parseInt(a)>0){i(parseInt(a));var b=f.getResponseHeader("X-Request-Details"),c=document.createElement("a");c.href=g,""===c.protocol&&""===c.host&&(c.protocol=location.protocol,c.host=location.host);var d=c.protocol+"//"+c.host+b,k=location.protocol===c.protocol&&location.host===c.host?("/"===c.pathname.slice(0,1)?c.pathname:"/"+c.pathname)+c.search+c.hash:c.href;h(j+" "+k,d)}}e&&e()}var d,e,f=this,g=this._url,j=this._method;this.noIntercept||(d=new Date,this.addEventListener?this.addEventListener("readystatechange",b,!1):(e=this.onreadystatechange,this.onreadystatechange=b)),c.call(this,a)}}(XMLHttpRequest)}).apply({});